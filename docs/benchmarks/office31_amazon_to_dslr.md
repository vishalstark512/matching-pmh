...
> **Preset:** `t1_office31_sklearn`. T1 paper_protocol (pool/test split, rank 32). Do **not** cite pre-2026-05-19 tables with B0 ≈ 0.7 / rank 16. See [CORRECT_USAGE.md](../CORRECT_USAGE.md).
