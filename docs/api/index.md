...
Autogenerated from docstrings (`mkdocstrings`). Read **[Correct usage](../CORRECT_USAGE.md)** first (paper fidelity, presets, isotropic naming). See also [Getting started](../GETTING_STARTED.md) and [Training API](../training.md).
