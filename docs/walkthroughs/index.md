...
|---|-------|------|----------|--------|
| 1 | [PyTorch domain shift (D4)](01-pytorch-domain-d4.md) | D4 | PyTorch model, source/target loaders | `01_domain_shift_d4.py` |
| 2 | [ResNet / torchvision D4](02-resnet-vision-d4.md) | D4 | Image folders, ResNet hook | `12_resnet_hook_d4.py` |
| 3 | [Frozen features + sklearn (D1)](03-office31-sklearn-d1.md) | D1 | `.npy` or extract features | `06_office31_sklearn.py` |
...
| 6 | [LLM style D7](06-llm-style-d7.md) | D7 | Style JSONL pairs | `08_hf_style_d7.py` |
...
| 12 | [ViT CLS D4](12-vit-cls-d4.md) | D4 | timm / ViT | `14_vit_cls_d4.py` |
